        ...
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
            <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
              <div className="rounded-lg h-64 overflow-hidden">
                <img
                  src={urlFor(data.blogimage1)} // Use the url directly from urlFor
                  alt="content"
                  className="object-cover object-center h-full w-full"
                  width={370}
                  height={255}
            ...
            <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
              <div className="rounded-lg h-64 overflow-hidden">
                <img
                  src={urlFor(data.blogimage2)} // Use the url directly from urlFor
                  alt="content"
                  className="object-cover object-center h-full w-full"
                  width={370}
                  height={255}
            ...
            <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
              <div className="rounded-lg h-64 overflow-hidden">
                <img
                  src={urlFor(data.blogimage3)} // Use the url directly from urlFor
                  alt="content"
                  className="object-cover object-center h-full w-full"
                  width={370}
                  height={255}
